...
#' @note
#'
#' @details A model that is underfitting zero-counts indicates a zero-inflation
#'    in the data, i.e. it is recommended to use negative binomial or
#'    zero-inflated models then.
#'
#' @examples
#'
