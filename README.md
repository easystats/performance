...
#>      Marginal R2: 0.824 (89% CI [0.745, 0.887])
...
#> 
#> Name |   Model |      AIC |      BIC |   RMSE |  Sigma | Score_log | Score_spherical |    R2 | R2 (adj.) | Tjur's R2 | Log_loss |   PCP | R2 (cond.) | R2 (marg.) |   ICC
#> -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#> m4   |     glm |   56.761 |   57.747 |  3.043 |  1.132 |    -2.598 |           0.324 |       |           |           |          |       |            |            |
```
