...
\
[`check_model`](https://easystats.github.io/performance/reference/check_model.md)`(``model1``, size_dot ``=`` ``1.2``)`\
...
\
[`check_overdispersion`](https://easystats.github.io/performance/reference/check_overdispersion.md)`(``model1``)`\
...
\
[`check_zeroinflation`](https://easystats.github.io/performance/reference/check_zeroinflation.md)`(``model1``)`\
...
`  data ``=`` ``glmmTMB``::`[`Salamanders`](https://rdrr.io/pkg/glmmTMB/man/Salamanders.html)\
`)`\
[`check_model`](https://easystats.github.io/performance/reference/check_model.md)`(``model2``, size_dot ``=`` ``1.2``)`\
`` #> `check_outliers()` does not yet support models of class `glmmTMB`. ``
...
\
[`check_overdispersion`](https://easystats.github.io/performance/reference/check_overdispersion.md)`(``model2``)`\
`#> # Overdispersion test (using simulated residuals)`\
`#> `\
...
`#> Overdispersion detected.`\
\
[`check_zeroinflation`](https://easystats.github.io/performance/reference/check_zeroinflation.md)`(``model2``)`\
`#> # Check for zero-inflation`\
`#> `\
`#>    Observed zeros: 387`\
`#>   Predicted zeros: 386`\
...
`  data ``=`` ``glmmTMB``::`[`Salamanders`](https://rdrr.io/pkg/glmmTMB/man/Salamanders.html)\
`)`\
[`check_model`](https://easystats.github.io/performance/reference/check_model.md)`(``model3``, size_dot ``=`` ``1.2``)`\
`` #> `check_outliers()` does not yet support models of class `glmmTMB`. ``
...
\
[`check_overdispersion`](https://easystats.github.io/performance/reference/check_overdispersion.md)`(``model3``)`\
`#> # Overdispersion test (using simulated residuals)`\
`#> `\
...
\
[`check_zeroinflation`](https://easystats.github.io/performance/reference/check_zeroinflation.md)`(``model3``)`\
`#> # Check for zero-inflation`\
`#> `\
`#>    Observed zeros: 387`\
`#>   Predicted zeros: 386`\
...
\
`result`` ``<-`` `[`compare_performance`](https://easystats.github.io/performance/reference/compare_performance.md)`(`\
...
\
[`test_performance`](https://easystats.github.io/performance/reference/test_performance.md)`(``model1``, ``model2``, ``model3``)`\
`#> Name   |   Model |     BF`\
`#> -------------------------`\
`#> model1 | glmmTMB |       `\
`#> model2 | glmmTMB | > 1000`\
...
\
[`test_performance`](https://easystats.github.io/performance/reference/test_performance.md)`(``model2``, ``model3``)`\
`#> Name   |   Model |     BF`\
`#> -------------------------`\
`#> model2 | glmmTMB |       `\
`#> model3 | glmmTMB | > 1000`\
`#> Models were detected as nested (in terms of fixed parameters) and are compared in sequential order.`\
\
[`test_likelihoodratio`](https://easystats.github.io/performance/reference/test_performance.md)`(``model2``, ``model3``)`\
...
`  data ``=`` ``glmmTMB``::`[`Salamanders`](https://rdrr.io/pkg/glmmTMB/man/Salamanders.html)\
`)`\
[`check_model`](https://easystats.github.io/performance/reference/check_model.md)`(``model4``, size_dot ``=`` ``1.2``)`\
`` #> `check_outliers()` does not yet support models of class `glmmTMB`. ``
...
\
\
[`check_overdispersion`](https://easystats.github.io/performance/reference/check_overdispersion.md)`(``model4``)`\
`#> # Overdispersion test (using simulated residuals)`\
`#> `\
...
`#> No overdispersion detected.`\
\
[`check_zeroinflation`](https://easystats.github.io/performance/reference/check_zeroinflation.md)`(``model4``)`\
`#> # Check for zero-inflation`\
`#> `\
`#>    Observed zeros: 387`\
`#>   Predicted zeros: 385`\
...
\
[`test_likelihoodratio`](https://easystats.github.io/performance/reference/test_performance.md)`(``model3``, ``model4``)`\
