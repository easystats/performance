...
\
`model`` ``<-`` ``glmmTMB``::`[`glmmTMB`](https://rdrr.io/pkg/glmmTMB/man/glmmTMB.html)`(`\
...
`simulated_residuals`` ``<-`` `[`simulate_residuals`](https://easystats.github.io/performance/reference/simulate_residuals.md)`(``model``)`\
\
`simulated_residuals`\
...
\
[`head`](https://rdrr.io/r/utils/head.html)`(`[`residuals`](https://rdrr.io/r/stats/residuals.html)`(``simulated_residuals``)``)`\
...
\
`DHARMa``::`[`testUniformity`](https://rdrr.io/pkg/DHARMa/man/testUniformity.html)`(``simulated_residuals``, plot ``=`` ``FALSE``)`\
`#> `\
...
\
[`check_residuals`](https://easystats.github.io/performance/reference/check_residuals.md)`(``simulated_residuals``)`\
...
\
[`check_overdispersion`](https://easystats.github.io/performance/reference/check_overdispersion.md)`(``simulated_residuals``)`\
...
\
[`check_zeroinflation`](https://easystats.github.io/performance/reference/check_zeroinflation.md)`(``simulated_residuals``)`\
...
\
[`check_outliers`](https://easystats.github.io/performance/reference/check_outliers.md)`(``simulated_residuals``)`\
...
\
[`str`](https://rdrr.io/r/utils/str.html)`(``simulated_residuals``, max.level ``=`` ``1``)`\
`#> List of 18`\
...
`#>  $ time                   : 'proc_time' Named num [1:5] 0.253 0.002 0.255 0 0`\
