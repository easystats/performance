...
\
[`citation`](https://rdrr.io/r/utils/citation.html)`(``"performance"``)`\
...
[`r2`](https://easystats.github.io/performance/reference/r2.md)`(``model``)`\
`#> # R2 for Linear Regression`\
`#>        R2: 0.830`\
`#>   adj. R2: 0.819`\
\
`model`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``am`` ``~`` ``wt`` ``+`` ``cyl``, data ``=`` ``mtcars``, family ``=`` ``binomial``)`\
[`r2`](https://easystats.github.io/performance/reference/r2.md)`(``model``)`\
`#> # R2 for Logistic Regression`\
`#>   Tjur's R2: 0.705`\
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`MASS`](http://www.stats.ox.ac.uk/pub/MASS4/)`)`\
[`data`](https://rdrr.io/r/utils/data.html)`(``housing``)`\
`model`` ``<-`` `[`polr`](https://rdrr.io/pkg/MASS/man/polr.html)`(``Sat`` ``~`` ``Infl`` ``+`` ``Type`` ``+`` ``Cont``, weights ``=`` ``Freq``, data ``=`` ``housing``)`\
[`r2`](https://easystats.github.io/performance/reference/r2.md)`(``model``)`\
...
\
`model`` ``<-`` `[`stan_glmer`](https://mc-stan.org/rstanarm/reference/stan_glmer.html)`(`\
...
[`library`](https://rdrr.io/r/base/library.html)`(`[`lme4`](https://github.com/lme4/lme4/)`)`\
`model`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``Reaction`` ``~`` ``Days`` ``+`` ``(``1`` ``+`` ``Days`` ``|`` ``Subject``)``, data ``=`` ``sleepstudy``)`\
[`icc`](https://easystats.github.io/performance/reference/icc.md)`(``model``)`\
...
[`set.seed`](https://rdrr.io/r/base/Random.html)`(``123``)`\
`model`` ``<-`` `[`brm`](https://paulbuerkner.com/brms/reference/brm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``(``1`` ``|`` ``cyl``)`` ``+`` ``(``1`` ``+`` ``wt`` ``|`` ``gear``)``, data ``=`` ``mtcars``)`
...
`model`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``count`` ``~`` ``spp`` ``+`` ``mined``, family ``=`` ``poisson``, data ``=`` ``Salamanders``)`\
[`check_overdispersion`](https://easystats.github.io/performance/reference/check_overdispersion.md)`(``model``)`\
`#> # Overdispersion test`\
`#> `\
...
\
`model`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``count`` ``~`` ``spp`` ``+`` ``mined``, family ``=`` ``poisson``, data ``=`` ``Salamanders``)`\
[`check_zeroinflation`](https://easystats.github.io/performance/reference/check_zeroinflation.md)`(``model``)`\
`#> # Check for zero-inflation`\
`#> `\
`#>    Observed zeros: 387`\
`#>   Predicted zeros: 298`\
...
`# prepare data`\
[`set.seed`](https://rdrr.io/r/base/Random.html)`(``123``)`\
`sleepstudy``$``mygrp`` ``<-`` `[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``5``, size ``=`` ``180``, replace ``=`` ``TRUE``)`\
`sleepstudy``$``mysubgrp`` ``<-`` ``NA`\
`for`` ``(``i`` ``in`` ``1``:``5``)`` ``{`\
`  ``filter_group`` ``<-`` ``sleepstudy``$``mygrp`` ``==`` ``i`\
`  ``sleepstudy``$``mysubgrp``[``filter_group``]`` ``<-`\
`    `[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``30``, size ``=`` `[`sum`](https://rdrr.io/r/base/sum.html)`(``filter_group``)``, replace ``=`` ``TRUE``)`\
`}`\
\
`# fit strange model`\
`model`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(`\
`  ``Reaction`` ``~`` ``Days`` ``+`` ``(``1`` ``|`` ``mygrp`` ``/`` ``mysubgrp``)`` ``+`` ``(``1`` ``|`` ``Subject``)``,`\
`  data ``=`` ``sleepstudy`\
`)`\
\
[`check_singularity`](https://easystats.github.io/performance/reference/check_singularity.md)`(``model``)`\
`#> [1] TRUE`
...
\
[`data`](https://rdrr.io/r/utils/data.html)`(``cars``)`\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``dist`` ``~`` ``speed``, data ``=`` ``cars``)`\
\
[`check_heteroscedasticity`](https://easystats.github.io/performance/reference/check_heteroscedasticity.md)`(``model``)`\
...
\
`# defining a model`\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``am`` ``+`` ``gear`` ``+`` ``vs`` ``*`` ``cyl``, data ``=`` ``mtcars``)`\
\
`# checking model assumptions`\
[`check_model`](https://easystats.github.io/performance/reference/check_model.md)`(``model``)`
...
\
`m1`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``wt`` ``+`` ``cyl``, data ``=`` ``mtcars``)`\
[`model_performance`](https://easystats.github.io/performance/reference/model_performance.md)`(``m1``)`\
...
\
`m2`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` ``wt`` ``+`` ``mpg``, data ``=`` ``mtcars``, family ``=`` ``"binomial"``)`\
[`model_performance`](https://easystats.github.io/performance/reference/model_performance.md)`(``m2``)`\
`#> # Indices of model performance`\
`#> `\
...
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`lme4`](https://github.com/lme4/lme4/)`)`\
`m3`` ``<-`` `[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``Reaction`` ``~`` ``Days`` ``+`` ``(``1`` ``+`` ``Days`` ``|`` ``Subject``)``, data ``=`` ``sleepstudy``)`\
[`model_performance`](https://easystats.github.io/performance/reference/model_performance.md)`(``m3``)`\
`#> # Indices of model performance`\
`#> `\
...
\
`counts`` ``<-`` `[`c`](https://rdrr.io/r/base/c.html)`(``18``, ``17``, ``15``, ``20``, ``10``, ``20``, ``25``, ``13``, ``12``)`\
`outcome`` ``<-`` `[`gl`](https://rdrr.io/r/base/gl.html)`(``3``, ``1``, ``9``)`\
`treatment`` ``<-`` `[`gl`](https://rdrr.io/r/base/gl.html)`(``3``, ``3``)`\
`m4`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``counts`` ``~`` ``outcome`` ``+`` ``treatment``, family ``=`` `[`poisson`](https://rdrr.io/r/stats/family.html)`(``)``)`\
\
[`compare_performance`](https://easystats.github.io/performance/reference/compare_performance.md)`(``m1``, ``m2``, ``m3``, ``m4``, verbose ``=`` ``FALSE``)`\
...
\
[`compare_performance`](https://easystats.github.io/performance/reference/compare_performance.md)`(``m1``, ``m2``, ``m3``, ``m4``, rank ``=`` ``TRUE``, verbose ``=`` ``FALSE``)`\
`#> # Comparison of Model Performance Indices`\
`#> `\
...
`lm2`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``+`` ``Petal.Length``, data ``=`` ``iris``)`\
`lm3`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Sepal.Width``, data ``=`` ``iris``)`\
`lm4`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Sepal.Width`` ``+`` ``Petal.Length`` ``+`` ``Petal.Width``, data ``=`` ``iris``)`\
\
[`test_performance`](https://easystats.github.io/performance/reference/test_performance.md)`(``lm1``, ``lm2``, ``lm3``, ``lm4``)`\
...
\
[`test_bf`](https://easystats.github.io/performance/reference/test_performance.md)`(``lm1``, ``lm2``, ``lm3``, ``lm4``)`\
