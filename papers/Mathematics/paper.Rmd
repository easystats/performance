...
For univariate outliers, it is recommended [@leys2019outliers; @leys2013outliers] to use the Median Absolute Deviation (MAD). In easystats' `check_outliers()`,one can use this approach with `method = "zscore_robust"`.
