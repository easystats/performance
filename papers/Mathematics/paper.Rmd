...
We have at this point demonstrated how to identify outliers. But what should we do with these outliers once identified? There is no one-size-fits-all rule, as this depends on several factors. For example, @leys2019outliers distinguishes between error outliers, interesting outliers, and random outliers.
