...
\Title{Check your outliers! An accessible introduction to identifying
...
Patil$^{3}$\href{https://orcid.org/0000-0003-1995-6531}{\orcidicon}, Dominique
Makowski$^{4}$\href{https://orcid.org/0000-0001-5375-9967}{\orcidicon}}

% Authors, for metadata in PDF
\AuthorNames{Rémi Thériault, Mattan S. Ben-Shachar, Indrajeet
Patil, Dominique Makowski}
...
$^{4}$ \quad School of Psychology, University of Sussex, Brighton,
UK; \\
}
...
ecosystem makes it easy to diagnose outliers according to current best
practices thanks to the \texttt{check\_outiers()} function.}

% Abstract (Do not insert blank lines, i.e. \\)
\abstract{Beyond the challenge of keeping informed about best practices
regarding the diagnosis and treament of outliers, an additional
...
recommandations and best practices and demonstrate how these can be
easily and conveniently implemented in the R software using the
\emph{\{performance\}} package of the \emph{easystats} ecosystem. We
cover univariate, multivariate, and model-based statistical outlier
detection methods, their recommended threshold, standard output, and
plotting method. We conclude with recommendations on the handling of
outliers, that is, the different theoretical types of outliers, whether
to exclude or winsorize them, and the importance of transparency.}
