...
authors:
  - name: Rémi Thériault
    ...
    affiliation: Department of Psychology, Université du Québec à Montréal, Montréal, Québec, Canada
  - name: Mattan S. Ben-Shachar
    orcid: 0000-0002-4287-4801
    affiliation: Independent Researcher, Ramat Gan, Israel
  - name: Indrajeet Patil
    orcid: 0000-0003-1995-6531
    affiliation: Center for Humans and Machines, Max Planck Institute for Human Development, Berlin, Germany
  - name: Daniel Lüdecke
    orcid: 0000-0002-8895-3206
    affiliation: Institute of Medical Sociology, University Medical Center Hamburg-Eppendorf, Germany
...
```{r model2, fig.cap = "Visual depiction of outliers based on Cook's distance (leverage and standardized residuals), based on the fitted model."}
model <- lm(disp ~ mpg * disp, data = data)
outliers <- check_outliers(model, method = "cook")
outliers
