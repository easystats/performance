...
times that are clearly invalid, such as those under 150 ms, which is
close to the minimal physiological limit for reacting to a visual
stimulus. \citet{miller2023outlier} also suggests that it is generally
better to assess outliers within specific experimental conditions or
groups (a condition-specific strategy), rather than across the entire
dataset at once (a pooled strategy), particularly in the case of
reaction times.
