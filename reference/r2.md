...
- Generalized linear models: [Nagelkerke's
...
- Beta or ordered Beta: [Ferrari's
  R2](https://easystats.github.io/performance/reference/r2_ferrari.md)
...
- Additional model families from package *glmmTMB* that are not
  mentioned above (like `nbinom1`, `compois`, `betabinomial` etc.)
  default to [McFadden's
  R2](https://easystats.github.io/performance/reference/r2_mcfadden.md).

- R2 for models from package *gamlss* is extracted directly from the
  [`summary()`](https://rdrr.io/r/base/summary.html), if available.
  Else, [McFadden's
  R2](https://easystats.github.io/performance/reference/r2_mcfadden.md)
  is returned.
